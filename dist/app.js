...
function Window({ url, ...props }) {
    if (!props.visible) {
        props.fillChar = '\x09';
    }
    return (_jsx("cont", { ...props, children: _jsx(MemoryRouter, { initialEntries: [url], children: _jsxs(Routes, { children: [_jsx(Route, { path: "/finder", element: _jsx(Finder, {}) }), _jsx(Route, { path: "/edit", element: _jsx(Edit, {}) }), _jsx(Route, { path: "/term", element: _jsx(Term, {}) }), _jsx(Route, { path: "/", element: _jsx(Homepage, {}) })] }) }) }));
}
                ...
                case '\x1b[\x42': {
                    ...
                    setWindowing((windowing) => {
                        ...
                        if (newSubfocusAt in windowing)
                            windowing[newSubfocusAt - 1].visible = true;
                        return [...windowing];
                    });
                    break;
                }
...
export function App() {
    ...
    return (_jsx("zjoin", { children: _jsxs(windowingContext.Provider, { value: [windowing, setWindowing], children: [windowing.map((v, i) => (_jsx(Window, { url: v.url, disabled: !v.visible || wmState === WindowStates.SWITCHING_WINDOWS, visible: v.visible }, v.id))), _jsxs("para", { invert: true, fillChar: '\x09', children: [" ", selectedWinWithNewWin, "/", windowing.length, " "] }), wmState === WindowStates.SWITCHING_WINDOWS
